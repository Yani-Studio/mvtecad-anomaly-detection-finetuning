...
*An end-to-end framework delivering sub-millimeter defect localization using self-supervised learning.*
...
## 🎬 Live Demos
*Visualizing real-time anomaly localization and defect segmentation results.*

| Cable Anomaly | Grid Anomaly | Metal Nut Anomaly |
| :---: | :---: | :---: |
...
## 🚀 Executive Summary
This repository houses a high-performance **Anomaly Detection (AD) pipeline** optimized for industrial manufacturing. By leveraging **EfficientAd** and **Patchcore**, this project achieves near-perfect detection rates on the MVTec AD dataset, with specialized optimizations for Apple Silicon.
...
* **Duration:** 9 Days of continuous training

---

## 📊 Global Benchmarking Performance
| Category | EfficientAd AUROC | Patchcore AUROC | Selection | Status |
| :--- | :---: | :---: | :---: | :--- |
...
1. **Clone the repository:**
   ```bash
   git clone [https://github.com/YOUR_GITHUB_ID/mvtecad-anomaly-detection.git](https://github.com/YOUR_GITHUB_ID/mvtecad-anomaly-detection.git)<div align="center">
