...
This project originated from a fundamental challenge encountered during a **Reverse Engineering** course at **the Graduate School of Kyung Hee University**. Traditional static and dynamic analysis methods faced strict limitations when attempting to automatically trace and identify complex system anomalies. 
